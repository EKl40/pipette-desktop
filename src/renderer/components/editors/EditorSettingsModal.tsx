    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 pt-4 pb-3 shrink-0">
          <h2 id="editor-settings-title" className="text-lg font-bold text-content">{t('editorSettings.tabData')}</h2>          <ModalCloseButton testid="editor-settings-close" onClick={onClose} />
        </div>
